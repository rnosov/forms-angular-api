/*
 * forms-angular-api
 * https://github.com/rnosov/forms-angular-api
 *
 * Copyright (c) 2014 Roman Nosov
 * Licensed under the MIT license.
 * Server side component of the forms-angular framework authored by Mark Chapman
        ...
        if (!realType.instance) {
          ...
          if (realType.options.type) {
            ...
            if (typeType === 'string') {
              ...
              realType.instance = realType.options.type.name;
            }
          }
        }
